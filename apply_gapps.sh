...
$MagiskRoot/magiskpolicy --load $MountPointVendor/etc/selinux/precompiled_sepolicy --save $MountPointVendor/etc/selinux/precompiled_sepolicy "allow gmscore_app gmscore_app vsock_socket { create connect write read }" "allow gmscore_app device_config_runtime_native_boot_prop file read"
